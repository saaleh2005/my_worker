    ...
    if (request.method === "POST") {
      ...
      if (userMessage) {
        ...
        const hfResponse = await fetch(
          "https://api-inference.huggingface.co/models/gpt2", // مدل چت بات عمومی و تخصصی
          {
            method: "POST",
            headers: {
            ...
            body: JSON.stringify({
              inputs: `سوال: ${userMessage}\nجواب بده به فارسی با لحنی دوستانه و کاربردی، اگر سوال تخصصی آکواریوم بود، دقیق توضیح بده.`,
            }),
          }
        );
